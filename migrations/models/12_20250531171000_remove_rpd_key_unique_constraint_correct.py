...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE "review_point_definitions" DROP CONSTRAINT IF EXISTS "uid_review_poin_project_0c8e77";
    """
...
async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE "review_point_definitions" ADD CONSTRAINT "uid_review_poin_project_0c8e77" UNIQUE ("project_id", "key");
    """ 